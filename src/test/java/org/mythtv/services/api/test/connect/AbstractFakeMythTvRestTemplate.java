 ...
 *
 */
public abstract class AbstractFakeMythTvRestTemplate implements RestOperations {

	private AbstractMythFakeHttpResponseFactory mythResponseFactory;
	...
	/**
	 * Execute the given method on the provided URI. The {@link org.springframework.http.client.ClientHttpRequest} is processed using the {@link
	 * org.springframework.web.client.RequestCallback}; the response with the {@link org.springframework.web.client.ResponseExtractor}.
	 ...
	 * @return an arbitrary object, as returned by the {@link org.springframework.web.client.ResponseExtractor}
	 */
	protected <T> T doExecute(URI url, HttpMethod method, RequestCallback requestCallback,
			ResponseExtractor<T> responseExtractor) throws RestClientException {

		AbstractMythFakeHttpInputMessage response = null;
		try {
