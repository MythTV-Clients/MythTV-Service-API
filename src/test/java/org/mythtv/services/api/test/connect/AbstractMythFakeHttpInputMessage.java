 ...
 * 
 */
public abstract class AbstractMythFakeHttpInputMessage implements ClientHttpResponse {
	private FileInputStream stream;
	private HttpHeaders headers;
	/**
	 *
	 */
	public AbstractMythFakeHttpInputMessage(String filePath) {
		headers = new HttpHeaders();
		File f = new File(getResourceBasePath() + filePath);
		if(f.exists()){
