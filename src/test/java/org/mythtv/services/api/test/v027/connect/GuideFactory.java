...
public class GuideFactory extends ResponseFactory {
	...
	public AbstractMythFakeHttpInputMessage create(URI url) {
		if(url.getPath().endsWith("/GetChannelIcon")){
			return new org.mythtv.services.api.test.v026.connect.MythFakeHttpInputMessage("guide/GetChannelIcon.png");
		} else if (url.getPath().endsWith("/GetProgramGuide")){
			return new org.mythtv.services.api.test.v026.connect.MythFakeHttpInputMessage("guide/GetProgramGuide.json");
