...
import org.mythtv.services.core.domain.VideoLookup;

public class VideoLookupListDetails {

        private Integer count;
        private DateTime asOf;
        private String version;
        private String protoVer;
        private VideoLookupDetails[] videoLookups;
         ...
         */
        public VideoLookupDetails[] getVideoLookups() {
            return videoLookups;
        }
         ...
         */
        public void setVideoLookups( VideoLookupDetails[] videoLookups ) {
