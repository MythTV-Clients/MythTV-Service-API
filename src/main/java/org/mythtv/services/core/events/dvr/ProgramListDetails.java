...
import org.mythtv.services.core.domain.Program;

public class ProgramListDetails {
         ...
         * @return the programs
         */
        public ProgramDetails[] getPrograms() {
            return programs;
        }
         ...
         */
        public void setPrograms( ProgramDetails[] programs ) {
