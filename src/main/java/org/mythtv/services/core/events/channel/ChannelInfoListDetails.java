...
public class ChannelInfoListDetails {
        ...
        private ChannelInfoDetails[] channelInfos;
         ...
         */
        public ChannelInfoDetails[] getChannelInfos() {
            return channelInfos;
        }
         ...
         */
        public void setChannelInfos( ChannelInfoDetails[] channelInfos ) {
