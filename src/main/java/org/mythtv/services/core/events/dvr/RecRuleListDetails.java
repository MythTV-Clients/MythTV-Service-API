...
import org.mythtv.services.core.domain.RecRule;

public class RecRuleListDetails {
        ...
        private RecRuleDetails[] recRules;
         ...
         * @return the recRules
         */
        public RecRuleDetails[] getRecRules() {
            return recRules;
        }
         ...
         */
        public void setRecRules( RecRuleDetails[] recRules ) {
