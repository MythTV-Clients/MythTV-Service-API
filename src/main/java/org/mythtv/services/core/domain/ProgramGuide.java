...
import org.mythtv.services.core.events.guide.ProgramGuideDetails;
...
public class ProgramGuide {
    ...
    public ProgramGuideDetails toProgramGuideDetails() {

        ProgramGuideDetails details = new ProgramGuideDetails();
        try {
    ...
    public static ProgramGuide fromProgramGuideDetails( ProgramGuideDetails details ) {

        ProgramGuide programGuide = new ProgramGuide();
        try {
            BeanUtils.copyProperties( programGuide, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
