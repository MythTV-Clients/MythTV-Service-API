...
public class VideoMultiplex {
    ...
    public VideoMultiplexDetails toVideoMultiplexDetails() {

        VideoMultiplexDetails details = new VideoMultiplexDetails();
        try {
    ...
    public static VideoMultiplex fromVideoMultiplexDetails( VideoMultiplexDetails details ) {

        VideoMultiplex videoMultiplex = new VideoMultiplex();
        try {
            BeanUtils.copyProperties( videoMultiplex, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
