...
public class CaptureCard {
    ...
    public CaptureCardDetails toCaptureCardDetails() {

        CaptureCardDetails details = new CaptureCardDetails();
        try {
    ...
    public static CaptureCard fromCaptureCardDetails( CaptureCardDetails details ) {

        CaptureCard captureCard = new CaptureCard();
        try {
            BeanUtils.copyProperties( captureCard, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
