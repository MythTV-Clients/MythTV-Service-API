...
public class LiveStreamInfo {
    ...
    public LiveStreamInfoDetails toLiveStreamInfoDetails() {

        LiveStreamInfoDetails details = new LiveStreamInfoDetails();
        try {
    ...
    public static LiveStreamInfo fromLiveStreamInfoDetails( LiveStreamInfoDetails details ) {

        LiveStreamInfo liveStreamInfo = new LiveStreamInfo();
        try {
            BeanUtils.copyProperties( liveStreamInfo, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
