...
public class VideoMetadataInfo {
    ...
    public VideoMetadataInfoDetails toVideoMetadataInfoDetails() {

        VideoMetadataInfoDetails details = new VideoMetadataInfoDetails();
        try {
    ...
    public static VideoMetadataInfo fromVideoMetadataInfoDetails( VideoMetadataInfoDetails details ) {

        VideoMetadataInfo videoMetadataInfo = new VideoMetadataInfo();
        try {
            BeanUtils.copyProperties( videoMetadataInfo, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
