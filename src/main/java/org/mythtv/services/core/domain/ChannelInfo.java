...
public class ChannelInfo {
    ...
    public ChannelInfoDetails toChannelInfoDetails() {
    ...
    public static ChannelInfo fromChannelInfoDetails( ChannelInfoDetails details ) {

        ChannelInfo artworkInfo = new ChannelInfo();
        try {
