...
public class VideoLookup {
    ...
    public VideoLookupDetails toVideoLookupDetails() {

        VideoLookupDetails details = new VideoLookupDetails();
        try {
    ...
    public static VideoLookup fromVideoLookupDetails( VideoLookupDetails details ) {

        VideoLookup videoLookup = new VideoLookup();
        try {
            BeanUtils.copyProperties( videoLookup, details );
        } catch( IllegalAccessException e ) {
            e.printStackTrace();
        } catch( InvocationTargetException e ) {
            e.printStackTrace();
