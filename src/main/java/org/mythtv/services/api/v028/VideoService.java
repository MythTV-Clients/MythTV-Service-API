...
import org.mythtv.services.api.v028.beans.BlurayInfo;
import org.mythtv.services.api.v028.beans.VideoLookupList;
...
public interface VideoService {
	...
	VideoMetadataInfoList getVideoList(@Query("Folder") String folder, @Query("Sort") String sort, @Query("Descending") Boolean descending, @Query("StartIndex") Integer startIndex, @Query("Count") Integer count, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Video/GetVideoList")
    void getVideoList(@Query("Folder") String folder, @Query("Sort") String sort, @Query("Descending") Boolean descending, @Query("StartIndex") Integer startIndex, @Query("Count") Integer count, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<VideoMetadataInfoList> callback);
	 ...
	 */
	@Headers({"Accept: application/json"})
    @POST("/Video/UpdateVideoWatchedStatus")
	Bool updateVideoWatchedStatus(@Query("Id") Integer id, @Query("Watched") Boolean watched);
    ...
    @Headers({"Accept: application/json"})
    @POST("/Video/UpdateVideoWatchedStatus")
    void updateVideoWatchedStatus(@Query("Id") Integer id, @Query("Watched") Boolean watched, Callback<Bool> callback);
