...
import org.mythtv.services.api.v028.beans.FrontendList;
...
public interface MythService {
	 ...
	 */
	@Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatDate")
	String getFormatDate(@Query("Date") org.joda.time.DateTime date, @Query("ShortDate") Boolean shortDate, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatDate")
    void getFormatDate(@Query("Date") org.joda.time.DateTime date, @Query("ShortDate") Boolean shortDate, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<String> callback);
	 ...
	 */
	@Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatDateTime")
	String getFormatDateTime(@Query("DateTime") org.joda.time.DateTime dateTime, @Query("ShortDate") Boolean shortDate, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatDateTime")
    void getFormatDateTime(@Query("DateTime") org.joda.time.DateTime dateTime, @Query("ShortDate") Boolean shortDate, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<String> callback);
	 ...
	 */
	@Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatTime")
	String getFormatTime(@Query("Time") org.joda.time.DateTime time, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Myth/GetFormatTime")
    void getFormatTime(@Query("Time") org.joda.time.DateTime time, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<String> callback);
	 ...
	 */
	@Headers({"Accept: application/json"})
    @GET("/Myth/GetFrontends")
	FrontendList getFrontends(@Query("OnLine") Boolean onLine, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Myth/GetFrontends")
    void getFrontends(@Query("OnLine") Boolean onLine, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<FrontendList> callback);
	 ...
	 */
	@Headers({"Accept: application/json"})
    @GET("/Myth/ParseISODateString")
	org.joda.time.DateTime parseISODateString(@Query("DateTime") String dateTime, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId);
    ...
    @Headers({"Accept: application/json"})
    @GET("/Myth/ParseISODateString")
    void parseISODateString(@Query("DateTime") String dateTime, @Header("If-None-Match") ETagInfo etagInfo, @Header("MYTH_REQUEST_ID") String headerMythRequestId, Callback<org.joda.time.DateTime> callback);
	...
	Bool sendMessage(@Query("Message") String message, @Query("Address") String address, @Query("udpPort") Integer udpPort, @Query("Timeout") Integer timeout);
    ...
    @Headers({"Accept: application/json"})
    @POST("/Myth/SendMessage")
    void sendMessage(@Query("Message") String message, @Query("Address") String address, @Query("udpPort") Integer udpPort, @Query("Timeout") Integer timeout, Callback<Bool> callback);
