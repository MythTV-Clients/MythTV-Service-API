...
public class BlurayInfo {
     ...
     */
    public Boolean getTopMenuSupported() {
     ...
     */
    public Boolean getFirstPlaySupported() {
     ...
     */
    public Boolean getAACSDetected() {
        return aACSDetected;
    }
     ...
     */
    public Boolean getLibAACSDetected() {
     ...
     */
    public Boolean getBDPlusDetected() {
     ...
     */
    public Boolean getLibBDPlusDetected() {
     ...
     */
    public Boolean getBDPlusHandled() {
