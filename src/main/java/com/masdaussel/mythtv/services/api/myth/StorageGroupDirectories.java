...
public class StorageGroupDirectories {
	...
	/**
	 * @param storageGroupDirectories
	 *            the storageGroupDirectories to set
	 */
	public void setStorageGroupDirectories(final List<StorageGroupDirectory> storageGroupDirectories) {
