...
public interface MythOperations {
	 ...
	 * @return
	 */
	List<LogMessage> getLogs(String hostname, String application, int pid, int tid, String thread, String filename, int line, String function, Date from,
			Date to, String level, String messageContains);
